...
abstract class JoseObject<P extends JosePayload> {
  ...
  static String encodeSegments(Iterable<Base64EncodedData> segments) => segments.map((s) => s.encode()).join('.');
}
...
abstract class Base64EncodedData {
  ...
  static Iterable<int> decodeToBytes(String base64String) => base64ToBytes(padIfRequired(base64String));

  static String decodeToString(String base64String) => new String.fromCharCodes(decodeToBytes(base64String));
}
...
abstract class Base64EncodedJson extends Base64EncodedData {
  ...
  static Map decodeToJson(String base64String) => json.decode(Base64EncodedData.decodeToString(base64String));
}
